              ...
              <div class="searchbar-wrapper">
                  ...
                  <div class="searchbar-center">
                      ...
                      <input onChange={(event)=> {
                          ...
                          }}    type="text" class="searchbar-input" maxlength="2048"  id="searchInput"  placeholder="Search Doctors"/>
                  </div>
                        ...
                        return(
                            <div className="card" key={val.id}>
                                  <div className="card-details">
                                    <center>
                                      <h5 className="des-show">{val.description}</h5>
                                      </center>
                                      <img className="render-images" src={val.image} alt="images" />
                                      
                                  </div>
                                  <Link to="/doctorsinfoPage"><button class="card-button" >More info</button></Link>
                            </div>
