  ...
  return (
    <div className="info-section" id="services">
      ...
      <div className="info-cards-content">
            <div class="newcard">
              <p class="newcard-title">Emergency Care</p><br></br><br></br>
              <p class="small-desc">
              Our Emergency Care service is designed to be your reliable 
              support in critical situations. Whether it's a sudden illness,
              injury, or any medical concern that requires immediate attention,
              our team of dedicated healthcare professionals is available 24/7 to
              provide prompt and efficient care.
             </p>
              <div class="go-corner">
            ...
            <div class="newcard">
              <p class="newcard-title">Heart Disease</p><br></br><br></br>
              <p class="small-desc">
            ...
            <div class="newcard">
              <p class="newcard-title">Dental Care</p><br></br><br></br>
              <p class="small-desc">
